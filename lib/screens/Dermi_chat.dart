...
//             SizedBox(width:10),
//             Text("Dermi Chat",style: TextStyle(fontFamily: "Michroma",fontSize: 22,fontWeight: FontWeight.w400,color:Colors.white),)
//           ],
//         ),
//       ),
//       body: Column(
...
//                                  decoration:BoxDecoration(color:Color(0xFFE5FBF9),borderRadius: BorderRadius.circular(30),border: Border.all(color: darkgreen,width: 2)),
//                                 child:Padding(
...
//                                         child: Image.asset('assets/Chat_Bot_Logo.png',height:40),
//                                       ),
//                                       Row(
//                                         children: [
//                                           Text("Here is your ",style:TextStyle(fontWeight:FontWeight.w500,fontFamily: "Manrope",fontSize: 15 ),textAlign: TextAlign.center,),
//                                           Text("Dermi AI",style:TextStyle(fontWeight:FontWeight.w600,fontFamily: "Michroma",fontSize: 15,color:darkgreen ),textAlign: TextAlign.center,),
//                                         ],
//                                       ),
...
//                       hintText: "Chat here...",
//                       border: OutlineInputBorder(borderSide: BorderSide(color:darkgreen),borderRadius: BorderRadius.circular(30),),
...
//                       borderSide: BorderSide(color: darkgreen,width:2), // Border color when focused
//                       borderRadius: BorderRadius.circular(30),
//                     ),

//                     suffixIcon: IconButton(
//                           icon: isLoading == true?/* CircularProgressIndicator(
//                             valueColor: Colors.green,
//                             color:darkgreen,
                            
//                           )*/CircularProgressIndicator(
//                               valueColor: AlwaysStoppedAnimation<Color>(darkgreen), // valueColor parameter
//                               backgroundColor: Colors.transparent, // backgroundColor parameter
//                               value: null, // value parameter (null means indeterminate)
//                               strokeWidth: 4.0, // strokeWidth parameter
//                               semanticsLabel: 'Loading', // semanticsLabel parameter
//                               semanticsValue: 'Loading', // semanticsValue parameter
...
//   await flutterTts.setVoice({"name": "en-us-x-sfg#male_2-local"}); // Set male voice
...
//     return Padding(
//       padding:  EdgeInsets.only(right:message["sender"]=="user"? 0:50,
...
//                   child: Image.asset('assets/Chat_Screen_Logo_color.png',height:15),
//                 )),
...
//                   ? darkgreen
//                   : Ai_text_box_color,
//               borderRadius: BorderRadius.only(topLeft: message["sender"]=="user"?Radius.circular(15):Radius.circular(0),
//                                               topRight: message["sender"]=="user"?Radius.circular(0):Radius.circular(15),
//                                               bottomLeft:Radius.circular(15),
//                                               bottomRight:Radius.circular(15),),
//             ),
//             child:Text(
//               message["message"]!,
//               style: TextStyle(color: message["sender"]=="user"? Colors.white:Ai_text_color),
//             ),
//           ),
//         ],
//       ),
